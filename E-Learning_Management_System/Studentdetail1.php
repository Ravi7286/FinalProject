...
<head>
    ...
    <body>
        ...
        <h1 style="text-align: center;color: #DD2F6E;">Students details</h1><br>
           <form style=" width: 50vw; margin-left: 4vw;" method="post">     
        <div class="card-body">
            <?php 
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td ><button></button><a href='update.php?id=<?php echo $row['id'];?>'>Edit/Update</button></td>
