...
<header>
    ...
    <a href="#" class="logo"><i class="lab la-accusoft"></i>AceOne</a>
...
<div class="row">
    ...
    <form action="save.php" method="post">
        ...
        <input type="text" placeholder="your number" class="box" name="phone">
        <input type="text" placeholder="What can we help you with?" class="box" name="queri">
        <input type="submit" class="btn" value="send now" name="submit">
    </form>
...
<div class="footer">
    ...
    <h1 class="credit">created by <a href="#">G140</a> all rights reserved. </h1>
